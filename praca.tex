...
\begin{itemize}
  \item \textbf{operacyjno-rozpoznawcze}: BSP umożliwiające, rozpoznawanie oraz śledzenie obiektu/celu, a także monitorowanie i kontrole obszaru zainteresowania, np. granic lub strefy przybrzeżnej. Przykładem takieg dronu jest \textit{Lockheed Martin RQ-170 Sentinel};
  \item \textbf{bojowe}: BSP przenoszącce i używające środki bojowe/ środki rażenia np. \textit{Bayraktar TB2};
  \item \textbf{amunicja krążąca}: BSP umożliwijące wykrywanie, rozpoznanie oraz atak na wyznaczony cel poprzez autodestrukcje np. \textit{WB Electronics Warmate};
  \item \textbf{wsparcia}: BSP umożliwiające ewakuacje lub dostawe amunicji, wyposażenia, środków medycznych i żywności do wysuniętych stanowisk wojsk własnych. np. \textit{Kaman KARGO UAV} \cite{konkurs-mon}
\end{itemize}

\subsubsection{Cywilne zastosowania BSP}
\hspace{1cm}Wymienienie wszystkich cywilnych rozwiązańjest trudne, ponieważ rynek ten znajduje co chiwle kolejne zastosowania dronów. Ponieżej przedstawiono tylko pare najciekwszych rozwiązań.

\myparagraph{Transport medyczny}

\hspace{1cm}W czerwcu 2022 r. Polska Agencja Żeglugi Powietrznej wydała zgode na wykonowyanie regularnych długodystansowych BSP. Realizować będzie je firma transportowa na rzecz systemu opieki zdrowotnej. Połączenie obejmuje trase między WArszawa a Pułtuskiem i między Warszawą a Sochaczewem. Przewidywana częstotliwość lotów to 6-7 w tą i z powrotem w ciągu dnia. Obie te trasy mają długośc 60km i odbywają sie na wysokości 100m. Samolot posiada systemy wizyjne, które będą korygwały lot w przypadku wystąpienia przeszkód na jego trasie przelotu.\cite{pansa-lot-medyczny}

\begin{figure}[!h]
  \centering
  \includegraphics[width=10cm]{./Obrazy/Farada_G1.jpg}
  \caption{Samoot Farada G1 za pomocą którego będzie obywał sie transport medyczny w okolicach Warszawy}
  \source{\myurl{https://www.pansa.pl/wp-content/uploads/2022/02/IMG-20220213-WA0001-1024x577.jpg}}
  \end{figure}

\myparagraph{Ratownictwo}

\hspace{1cm}Drony powietrzne pomagają również w ratowniu ludzkiego życia, szczególnie w górach. W styczniu 2022 r. ze względu na trudne warunki atmosferyczne nie ratownicy TOPR nie mogli udzielić pomcy dwóm turystą którzy nie byli w stanie zejść z góry. Za pomocą drona dostarczono im koce i ogrzewacze co pozwoliło im przetrwać noc, a kolejnego dnia gdy pogoda sie poprawiła ratownicy dotarli do poszkodawancych i ich sprowadzili w bezpieczny sposob. \cite{topr-dron}

Nie tylko w Polsce można znaleźć przykłady użycia drona do ratowania życia, a również w Ameryce, a konkretnie w Północnej Kaliforni. Właśnie tam, w lesie, zgubił sie młody myśliwy. Służby za pomocą drona zlokalizowali jego lokalizacje a następnie wysłali tam ludzi, który z pomocą drona wyprowadzili zagubionego.\cite{bbc-drone-rescue} 


Są cztery powody dla którego BSP dobrze odnajdują sie w ratownictwie:
\begin{itemize}
  \item \textbf{Czas reakcji} - Drony są opcją bardzo szybkiego reagowania, czas potrzebny na przygotowania do startu jest minimalny;
  \item \textbf{Szybkie przeszukiwania} - Drony mogą przeszukac trudny teren w dużo szybszym czasie nie pieszo człowiek;
  \item \textbf{Komunikacja} - Za pomocą głosnika i mikrofonu statki powietrzne mogą koumunikować sie z poszkodowanymi;
  \item \textbf{Lokalizacja} - Wiekszość współczesnych dronów jest w stanie przekazywać na żywo do operatora swoją aktualną lokalzacje, co w przypadku ratowania i poszukiwania osób może znacznie minimalizować czas poszukiwania i ewakuacji. \cite{snowbrains-drone}
\end{itemize}

\myparagraph{Kinematografia i produkcja filmowa}

Drony zrewoucjonizowały Kinematografia i produkcje firmowa dostarczając nowe, często nawet tańsze narzędzia. Obecnie aby nagrać ujęcia z lotu ptaka nia ma potrzeby wynajmowania helikoptera czy dźwigu. Nagrania za pomocą BSP są często nawet lepsze od tych z helikopter ponieważ lot jest dużo bardziej stabilny, a kamera jest często wyposażona w 3-osiową stabilizacje. 

Jednym z pierwszych filmów które przywoływane są jako przykład dobrego wykorzystania dronów jest \textit{Skyfall} z 2012 r., a konkretnie scena pościgu motorem przez Jamsa Bonda złoczyńców po dachach w Istambule. BSP dały kinematografii wyjątkową przewagę nad tradycyjnymi metodami filmowania. Mają większy zasięg niż żuraw i są też bardziej zwinne niż heliktopter. Reżyserzy dzięki tmeu moga wykinwyać bardzije ryzykowne, prawdziwie akrobatyczne ujęcia, które gdyby nie drony musiały by być tworzone na komputerze. Bezpiltowe statki powietrzne są w dodatku tańsze w zakupie i utrzymaniu niż np. helikotpery. \cite{washingtonpost-drone-movie}


Przykładem gdzie wcześniej nie było możliwe nagrywanie ujęc filmowych są erupcje wulkanów, ponieważ takie loty wiązały sie z dużym niebezpieczeństwem. Ponieważ dorny są dużo tańsze i nie posiadają na swoim pokładzie załogi, operatorzy mogą pokusić sie o takie ryzyko. Nagranie takie wykonał znnay youtuber Joey Helms, który postanowił uwiecznić z bliska rzeke lawy wyrzucaną przez wulkan Fagradalsfjall na Islandii. W trakcie nagrywania erupcja lewy w pewnym momencie sięgneła jego statku. Youtuber bezpowrotnie stracił swój statek, ale ujęcie która zostało zachowane jest bardzo emocjonujące, więc prawdpodobnie było to wart swojej ceny.\cite{dron-lawa-pogoda}


\myparagraph{Transport towarów}

W 2013 r. Jeff Bezos ogłosił konepcje, która miała zrewocjunolizować trasnport towarów. Autnomiczne drony powietrzne miały dostarczać paczki Amazonu w 30 minut na podwórko odbiorcy. Mogły one zaoferować konsumentom dostawę żywności, leków czy innych lżejszych przedmiotów, bez spalania paliw kopalnianych i czekania. Niestety jednemu z najbogatszych ludzi na świecie nie udało sie tego osiągnąć, podcza gdy firma \textit{Zipline} miała dostarczać leki w Rwandzie, a projekt Google \textit{Wing} burito głodnym studentom. Na świecie istnieje duża presje na wprowadzenie takiego rozwiązanie, m.in. koszty transportu towaru miedzy centrum dystrybucji a klientem to 40\% całkowitego kosztu, a klienci oczkują szybkiej, tanij i ekologicznej dostawy.   

W 2021 r. Amazon zwolnił większość procwników odpowiedzialnych za rozwój wspominanego projektu, uzasadnił to błedem w zarządzaniu i panującym chaosem. W tym samym roku DHL również ogłosił zakończenie swojego identycznego proejkty. Było to 8 lat po tym gdy ich dron wzbił sie pierwszy raz w powitrze.

Jest pare czynników które mogły wpłynąć na wstrzymanie masowych dostaw towarów np. ograniczenie stref lotów BSP. Osoby zarządzające państwami i miastami na bierząco wprowadzaja prawo które ma zapewnić bezpieczeństwo, dlatego powstały strefy wyłączone dla dronów. Są to najcześciej okolice lotnisk i jednostek wojskowych. Takie strefy mocno ograniczają dostawy towarów dronami. \cite{drone-transport}

\begin{figure}[!ht]
  \centering
  \includegraphics[width=16cm]{./Obrazy/no2.png}
  \caption{\textit{No drone zone} okolicach Warszawy}
  \source{\myurl{https://www.dji.com/pl/flysafe/geo-map}}
  \end{figure}


Taki transport jest jednak nadal możliwy, ale nie na masową skale. W Sosnowcu od 2021 r. realizowany jest porjekt w którym drony będą świadczyły usługi transportu, w tym pilnych przesyłek medycznych. Odbiór i nadawanie będzie odbywało sie w stacjach dokującyh, które będą autmotycznie łądowały i zdejmowały ładunek z drona. Można w przyszłości spodziewać sie więcej podobnych rozwiązań.\cite{sosnowiec-drone}


\subsection{Dostosowywanie drona do wymagań użytkownika}
\hspace{1cm}Na rynku znajduje się bardzo dużo dostępnych kompontentów z których można budować własne drony powiterze, przedwszystkim kontrolery lotu, np. \textit{pixhawk}, na którym można zainstalować otwarte oprogramowanie \textit{ArduPilot}. Zdejmuje to z konstruktora koniecznośc impelemntacji własnej logiki zachowania silników w trakcie lotu. Przykładowy zestaw elementów potrzenych do zbudowania własnego drona to:
\begin{itemize}
  \setlength\itemsep{1mm} %TODO
  \item rama,
  \item silnik,
  \item elektorniczny kontroler prędkości,
  \item śmigła,
  \item załącza,
  ...
  \item odbironik RC,
  \item kamera,
  \item pendrive.\cite{how-to-build-drone}
\end{itemize}
...
\begin{figure}[!ht]
  ...
  \caption{Kontroler Pixhawk}
  \source{\myurl{https://ardupilot.org/plane/_images/Pixhawk_with_legend.jpg}}
  \end{figure}


Budowa własnego drona jest jak najbardziej możliwa, bez wymagania specjalistycznej wiedzy, ale nadal to potrzeba na to dużo zasobów, przedewszystkim czasu, daltego warto przyjrzeć się rozwiązanią dostarczanym przez producentów dronów.   

Bezzałogowe statki powietrzne znalazły szereg zastosowań, ale warto przyjeżeć sie czy i jak bardzo można dostosować dostarczane od najwiekszych producentów BSP. Firma DJI udostępnia do swoich produktów SDK, czyli biblioteke za pomocą której można dostosować logike działania naszego drona. Dodatkowo producent dla wybranych statków przygotował szereg rozszerzeń które pomogą dostosować działanie do naszych wymagań. Przykładowo dla \textit{Mavic 2 Enterprise Advaced} dostępne są:
\begin{itemize}
  ...
  \item \textbf{dodatkowe oświetlenie} - w przypadku wystąpinie niekorzystanych warunków atmosferycznych lub lotów w nocy
  \item \textbf{moduł RTK} - który umożliwia osiągnięcie dokładności lokalizacji na poziomie jednego centrymetra
\end{itemize} 
