...
\begin{center}
  \begin{table}[H]
    ...
    Scenariusz główny: &
      \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła \\ \\ komende przeznaczoną dla BSP\end{tabular} \\ \hline
   \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i \\ wykonaniu scenariusza głównego:\end{tabular} &
  ...
  \begin{table}[]
    ...
    Scenariusz główny: &
      \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła \\ komende przeznaczoną dla BSP dotyczącą \\ włączenia silników\end{tabular} \\ \hline
    \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i \\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{table}[]
  ...
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła \\ komende przeznaczoną dla BSP dotyczącą \\ wyłączenia silników\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i \\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{table}[]
  ...
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła \\ komende przeznaczoną dla BSP dotyczącą \\ wystartowania\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i \\ wykonaniu scenariusza głównego:\end{tabular} &
    BSP startuje \\ \hline
  \begin{tabular}[c]{@{}l@{}}Zawarte i rozszerzone przypadki \\ użycia:\end{tabular} &
    BRAK \\ \hline
...
\begin{table}[]
  ...
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła \\ komende przeznaczoną dla BSP dotyczącą \\ wylądowania\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i \\ wykonaniu scenariusza głównego:\end{tabular} &
    BSP ląduje \\ \hline
  \begin{tabular}[c]{@{}l@{}}Zawarte i rozszerzone przypadki \\ użycia:\end{tabular} &
...
\begin{table}[]
  ...
  Warunki wstępne:                                                                  & BRAK                             \\ \hline
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła\\ komende przeznaczoną dla BSP dotyczącą\\ ustawienie lokalizacji GoToHome\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i\\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{center}
  \begin{table}[]
    ...
    Warunki wstępne:                                                                  & BRAK                                      \\ \hline
    Scenariusz główny: &
      \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła\\ polecenie rozpoczęcia lotu\\ do lokalizacji GoToHome\end{tabular} \\ \hline
    \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i\\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{table}[]
  ...
  Warunki wstępne:                                                                  & BRAK                                      \\ \hline
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła\\ polecenie zakończenia lotu\\ do lokalizacji GoToHome\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i\\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{table}[]
  ...
  Warunki wstępne:        & BRAK              \\ \hline
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła\\ polecenie wykonania zdjęcia\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i\\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{table}[]
  ...
  Warunki wstępne: &
    BRAK \\ \hline
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. BSP na podany Topic przesyła wykonane \\ zdjęcie\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i\\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{table}[]
  ...
  Warunki wstępne:        & BRAK             \\ \hline
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła\\ komende z danymi misji\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i\\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{table}[]
  ...
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła\\ komende załadowania misji\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i\\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{table}[]
  ...
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła\\ komende rozpoczęcia wykonywania misji\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i\\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{table}[]
  ...
  Scenariusz główny: &
    \begin{tabular}[c]{@{}l@{}}1. Broker MQTT na podany Topic przesyła\\ komende wznowienia wykonywania misji\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Po spełnieniu warunków i\\ wykonaniu scenariusza głównego:\end{tabular} &
...
\begin{table}[]
  ...
  Opis przypadku użycia: &
    \begin{tabular}[c]{@{}l@{}}Broker MQTT na indywidualny Topic BSP\\ przesyła komende zakończenia wykonywania\\ misji\end{tabular} \\ \hline
  Aktor inicjalizujący:   & Broker MQTT                         \\ \hline
